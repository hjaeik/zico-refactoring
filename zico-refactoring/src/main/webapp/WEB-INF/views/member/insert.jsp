	...
	<div class="content" style="align: center;">
		...
		<form action="/member/insert" method="post" id="insertform">
			<div class="field half first">
				<label for="name">Name</label> <input class="handwrite" id="username" name="memberName" type="text" placeholder="Name">
			</div>
			<div class="field half">
				<label for="email">ID</label> <input class="handwrite" id="userid" name="memberId" type="text" placeholder="Id">
				<input type="hidden" id="chkid" value="false">
			</div>
				<span style="font-size:14px" id="checkid"></span>
			<div class="field">
				<label for="name">Password</label> <input class="handwrite" id="password" name="memberPassword" type="password" placeholder="Password" >
			</div>
			<div class="field">
			...
			<div class="field">
				...
				<div class="select-wrapper">
					<select id="handwrite" name="memberPwdHint">
			...
			<div class="field">
				<label for="name">Question Password</label> <input class="handwrite" id="questionanswer" name="memberPwdAnswer" type="text" placeholder="Qustion Password">
			</div>

			<div class="field">
				<label for="name">Phone Number</label> <input class="handwrite" name="memberPhone" id="userphone" type="text" placeholder="Phone Number">
			</div>
			<div class="field">
				<label for="dept">Class</label>
				<div class="select-wrapper">
					<select class="handwrite" name="memberGrade">
			...
			<ul class="actions align-center">
				<li><input value="등록" class="button special" id="insertbutton" readonly></li>
			</ul>
		</form>
	</div>
	<script>
